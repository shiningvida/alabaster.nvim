...
if vim.o.background == "dark" then
	...
	local floatborder = vim.g.alabaster_floatborder and { bg = bg, fg = "#2b3d40" }
			or {
				bg = float_bg,
				fg = float_bg,
			}
	theme = {
		...
		--- Markdown
		RenderMarkdownH1Bg                         = { bg = "#1D2B37", fg = "#71ade7" },
		RenderMarkdownH2Bg                         = { bg = "#271a33", fg = "#cc8bc9" },
		RenderMarkdownH3Bg                         = { bg = "#1a2e20", fg = "#95cb82" },
		RenderMarkdownH4Bg                         = { bg = "#2a2210", fg = "#cd974b" },
		RenderMarkdownH5Bg                         = { bg = "#1d2925", fg = "#47bea9" },
		RenderMarkdownH6Bg                         = { bg = "#182325", fg = "#708b8d" },
		--- Startify
	...
	theme = {
		...
		Constant = { fg = const_fg },
		String = { fg = string_fg },
		Character = { fg = ansi.magenta },
		Number = { fg = const_fg },
		Boolean = { fg = ansi.magenta },
		Float = { fg = ansi.magenta },
		Operator = { fg = "#708b8d" },
		...
		Repeat = { fg = ansi.yellow },
		Label = { fg = def_fg },
		Keyword = { fg = "#708b8d" },
		Exception = { fg = ansi.yellow },
